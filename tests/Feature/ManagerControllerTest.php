...
class ManagerControllerTest extends TestCase
{
    ...
    public function testIndex()
    {
        ...
        $response = $this->actingAs($user)->getJson('/api/manager/pengajuans');
    ...
    public function testRejectPengajuan()
    {
        ...
        $response = $this->actingAs($user)->postJson("/api/manager/pengajuans/{$pengajuan->id}/reject", ['reason' => 'Test reason']);
